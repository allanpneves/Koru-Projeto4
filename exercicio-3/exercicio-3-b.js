// Resolução do Exercício 3 - Desafio B

// Enunciado do exercicio com os dados a serem usados
...
// RESOLUÇÃO DO EXERCICIO 3 DESAFIO - B
...
console.log(`Nome: ${studentId3.name}, Idade: ${studentId3.age}, Ativo: ${studentId3.active}`);
