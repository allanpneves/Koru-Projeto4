...
// Resolução do Desafio E do Exercício-5
//e. Verifique se todos os produtos têm pelo menos uma avaliação (review)
const TemReviews=inventory.every(produtos=> produtos.reviews.length > 0);
console.log("Todos os produtos têm pelo menos uma avaliação:", TemReviews);