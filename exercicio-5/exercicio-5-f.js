// Resolução Exercício 5 Desafio F

// Enunciado Exercício 5 - Base de dados
...
// Resolução do Desafio F - Encontrar o índice do produto "Cafeteira"

const indexCafeteira = inventory.findIndex(item => item.name === "Cafeteira");

console.log(`A Cafeteira está na posição (índice): ${indexCafeteira}`);